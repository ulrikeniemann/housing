...
get_test_communes <- function(former_communes, current_communes){
  ...
  communes[which(communes == "Clemency")] <- "ClÃ©mency"
  communes[which(communes == "Redange")] <- "Redange-sur-Attert"
  communes[which(communes == "Erpeldange-sur-SÃ»re")] <- "Erpeldange"
  communes[which(communes == "Luxembourg City")] <- "Luxembourg"
  communes[which(communes == "KÃ¤erjeng")] <- "Kaerjeng"
  communes[which(communes == "Petange")] <- "PÃ©tange"
